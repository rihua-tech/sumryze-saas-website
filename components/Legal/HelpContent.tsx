  ...
  return (
      ...
      <main className="flex-1 pt-8">
        <div className="max-w-6xl mx-auto px-6 py-10 space-y-12">
          ...
          {/* ✅ Contact Support */}
          <section className="text-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border border-blue-200 dark:border-blue-800/30 p-8">
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">
              Still need help?
            </h2>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-gray-100 rounded-lg hover:bg-blue-700">
                <MessageCircle className="h-5 w-5" /> Live Chat
              </button>
              <button className="flex items-center gap-2 px-6 py-3 border dark:border-gray-600 rounded-lg">
                <Mail className="h-5 w-5" /> Email
              </button>
              <button className="flex items-center gap-2 px-6 py-3 border dark:border-gray-600 rounded-lg">
                <Phone className="h-5 w-5" /> Schedule Call
              </button>
            </div>
          </section>
        </div>
