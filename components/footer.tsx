    ...
    <footer className="bg-gray-50 border-t">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* ✅ Grid with 5 columns */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-7 gap-x-4 gap-y-4 items-start">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 group">
              ...
              />
              <span className="text-3xl font-black bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent hover:from-indigo-700 hover:to-purple-700 transition-all duration-200">
                Sumryze
              </span>
            </Link>

            <p className="mt-6 text-base text-gray-600 max-w-xs leading-relaxed">
          ...
          {/* Column 2: Product */}
          <div>
            <h3 className="text-base font-bold text-gray-900 tracking-wider uppercase mb-2">Product</h3>
            
              <ul className="pt-4 space-y-4 text-[8px]">
          ...
          {/* Column 3: Company */}
          <div>
            <h3 className="text-base font-bold text-gray-900 tracking-wider uppercase mb-2">Company</h3>
           <ul className="pt-4 space-y-4 text-[8px] ">
          ...
          {/* Column 4: Legal */}
          <div>
            <h3 className="text-base font-bold text-gray-900 tracking-wider uppercase mb-4">Legal</h3>
           <ul className="pt-4 space-y-4 text-[8px]">
          ...
          <div className="md:col-span-2">
            <h3 className="text-base font-bold text-gray-900 tracking-wider uppercase mb-2">Newsletter</h3>
             ...
             <input
               type="email"
                placeholder="Your email"
                 className="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-base"
                />
              <button
              type="submit"
              className="bg-indigo-600 hover:bg-indigo-700 text-white text-base px-5 py-3 rounded-md transition"
                  >
         Subscribe
            </button>
            </form>
