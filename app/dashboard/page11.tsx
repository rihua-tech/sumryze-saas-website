...
export default function Dashboard() {
  ...
  return (    
        <div className="max-w-7xl mx-auto px-5 py-0 space-y-8">
          
           <div className="flex text-center gap-4 mt-4 ml-6">
              <button className="text-green-600 font-medium">Overview</button>
               <span>|</span>
                <button className="text-white hover:text-gray-300">Reports</button>
                  <span>|</span>
                 <button className="text-white hover:text-gray-300">AI Content</button>
                <span>|</span>
               <button className="text-white hover:text-gray-300">Tools</button>
             </div>
